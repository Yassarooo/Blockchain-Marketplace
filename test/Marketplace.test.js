...
require('chai')
  ...
  //add 3 accounts to test scenario
contract('Marketplace', ([deployer, seller, buyer]) => {
  ...
  describe('products', async () => {
    ...
    before(async () => {
      result = await marketplace.createProduct('iPhone X',"description", web3.utils.toWei('1', 'Ether'),"imgipfshash","fileipfshash",0,{ from: seller })
